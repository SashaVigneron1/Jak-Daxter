...
#include "Scenes/Exam/JakAndDaxterScene.h"
#endif
...
void MainGame::OnGamePreparing(GameContext& gameContext)
{
	...
	gameContext.windowTitle = L"GP2 - Milestone 3 (2022) | (2DAE07) Vigneron Sasha";
...
void MainGame::Initialize()
{
	...
	SceneManager::Get()->AddGameScene(new JakAndDaxterScene());
#endif
