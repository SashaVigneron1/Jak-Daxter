...
public:
	...
	void SetAnimation(const AnimationClip& clip, int clipId = -1);
	...
	void EnableLooping(bool value) { m_IsLooping = value; }
	bool IsPlaying() const { return m_IsPlaying; }
	bool IsReversed() const { return m_Reversed; }
	float GetAnimationSpeed() const { return m_AnimationSpeed; }
	const AnimationClip& GetClip(int clipId) { return m_pMeshFilter->m_AnimationClips[clipId]; }
	...
	int GetCurrentClipId() { return m_CurrentClipId; }
