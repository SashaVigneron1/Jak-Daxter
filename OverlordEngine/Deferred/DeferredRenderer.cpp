...
void DeferredRenderer::Initialize()
{
	...
	const auto pDefaultRenderTarget = m_GameContext.pGame->GetRenderTarget();
	m_pDefaultRenderTargetView = pDefaultRenderTarget->GetRenderTargetView();
	m_pDefaultDepthStencilView = pDefaultRenderTarget->GetDepthStencilView();
